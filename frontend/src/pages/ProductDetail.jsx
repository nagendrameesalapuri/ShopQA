      ...
      <div className="container">
        ...
        >
          ...
          <div className="gallery" data-testid="product-gallery">
            <div className="main-image-wrap" data-testid="main-image-wrap">
              ...
              />
              {isOOS && (
                <div className="oos-overlay" data-testid="oos-overlay">
                  Out of Stock
                </div>
              )}
              {discount > 0 && (
                <div
                  className="img-discount-badge"
          ...
          <div className="product-info-panel" data-testid="product-info-panel">
            ...
            {product.brand && (
              <p className="product-brand-label" data-testid="product-brand">
                by {product.brand}
              </p>
            )}
            ...
            <div className="price-section" data-testid="price-section">
              <span className="detail-price" data-testid="product-detail-price">
                ₹{Number(product.price).toLocaleString("en-IN")}
              </span>
              {product.compare_price > product.price && (
                <>
                  <span className="detail-compare">
            ...
            {/* Short description */}
            {product.short_desc && (
              <p className="short-desc" data-testid="product-short-desc">
                {product.short_desc}
              </p>
            )}
              ...
              >
                ...
                >
                  <button
                    ...
                    data-testid="qty-btn-minus"
                    aria-label="Decrease quantity"
                  >
                    −
                  </button>
                  <span className="qty-num" data-testid="quantity-value">
                    {quantity}
                  </span>
                  <button
                    className="qty-btn"
            ...
            <div className="product-meta" data-testid="product-meta">
              <div className="meta-row">
                <span>SKU:</span>
                <span data-testid="product-sku">{product.sku || "N/A"}</span>
              </div>
              <div className="meta-row">
                <span>Category:</span>
                <Link
              ...
              {product.brand && (
                <div className="meta-row">
                  <span>Brand:</span>
                  <span data-testid="product-brand-meta">{product.brand}</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div style={{ marginTop: 48 }} id="reviews">
          <div className="tabs" data-testid="product-tabs">
            ...
            <button
              className={`tab ${tab === "specs" ? "active" : ""}`}
            ...
            <div className="tab-content" data-testid="specs-content">
              <table className="table">
                <tbody>
                  ...
                  {product.sku && (
                    <tr>
                      <td style={{ fontWeight: 700 }}>SKU</td>
                      <td>{product.sku}</td>
                    </tr>
                  )}
                  {product.weight && (
            ...
            <div className="tab-content" data-testid="reviews-content">
              ...
              <div className="reviews-header" data-testid="reviews-summary">
                <div className="avg-rating-block">
                  <span className="avg-rating-num" data-testid="avg-rating">
                    {Number(product.avg_rating || 0).toFixed(1)}
                  </span>
                  <StarRating
                    ...
                    >
                      ...
                      {review.title && (
                        <p
                          ...
                          data-testid="review-title-display"
                        >
                          {review.title}
                        </p>
                      )}
                      <p
                        ...
                        data-testid="review-body-display"
                      >
                        {review.body}
                      </p>
                    </div>
