      ...
      schemas: {
        ...
        Product: {
          ...
          properties: {
            ...
            stock: { type: "integer" },
            sku: { type: "string", example: "APP-0001" },
            ...
            images: {
              ...
              items: { type: "string" },
              description:
                "Relative URLs. Uploaded images are served from /api/products/images/{id} (stored in the database, not the app server's disk, so they survive backend restarts).",
            },
            specifications: {
              type: "object",
              description: "Free-form key/value spec sheet, e.g. { \"Display\": \"6.1\\\" OLED\", \"Warranty\": \"1-year\" }",
